...
string MergeUrl(string s1, const string &s2)
{
	int l = s1.length();
...
bool IfUrl(string &str, const string &dom)
{
...
int FindUrl(const string &str, const string &dom, const string &root, string res[])
{
